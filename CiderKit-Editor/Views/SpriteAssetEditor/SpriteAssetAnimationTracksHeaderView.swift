...
class SpriteAssetAnimationTracksHeaderView: NSTableHeaderView {
    ...
    init(frame: NSRect, asset: SpriteAssetDescription, animationState: String?) {
    ...
    private func addState() {
        ...
        repeat {
            ...
            if assetDescription.hasAnimationState(named: newAnimationStateName) {
                ...
                errorAlert.informativeText = "An animation state with the same name already exists fpr this sprite asset."
        ...
        assetDescription.animationStates[newAnimationStateName] = SpriteAssetAnimationState()
