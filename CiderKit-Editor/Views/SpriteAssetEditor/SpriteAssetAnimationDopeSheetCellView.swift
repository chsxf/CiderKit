...
class SpriteAssetAnimationDopeSheetCellView: SpriteAssetAnimationTrackBaseView {
    
    private static let frameWidth: CGFloat = 7
    
    private weak var animationControlDelegate: SpriteAssetAnimationControlDelegate? = nil
    
    private var animationTrack: SpriteAssetAnimationTrack { assetDescription.animationStates[animationControlDelegate!.currentAnimationState!]!.animationTracks[trackIdentifier]! }
    
    init(tableView: NSTableView, row: Int, assetDescription: SpriteAssetDescription, trackIdentifier: SpriteAssetAnimationTrackIdentifier, animationControlDelegate: SpriteAssetAnimationControlDelegate) {
