...
public struct MapDescription: Codable, Sendable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        regions = try container.decode([MapRegionDescription].self, forKey: .regions)
        lighting = try container.decode(LightingDescription.self, forKey: .lighting)
        renderers = try container.decode([String: CellRendererDescription].self, forKey: .renderers)
    ...
    public func encode(to encoder: any Encoder) throws {
        ...
        try container.encode(renderers, forKey: .renderers)
    }
